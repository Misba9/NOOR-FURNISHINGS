...
const ProductPage = () => {
  ...
  const seoData = {
    ...
    type: "article",
    canonical: `https://www.noorfurnishings.com/subcategories/${category}/${subcategory}`
  };
    ...
    <>
      ...
      <div>
        <section className="relative h-64 overflow-hidden">
          ...
          <img
            src={productImages[0]}
            alt={`Premium ${subcategoryTitle} - NOOR FURNISHINGS`}
                ...
                <div className="grid grid-cols-2 gap-4">
                  {productImages.map((image, index) => (
                    ...
                    >
                      <img
                        src={image}
                        alt={`Premium ${subcategoryTitle} ${index + 1} - NOOR FURNISHINGS`}
                ...
                >
                  <Link to={product.link} className="group">
                    <div className="relative overflow-hidden rounded-lg shadow-lg transform group-hover:-translate-y-2 transition-all duration-300">
                      <img
                        src={product.image}
                        alt={`${product.name} - Premium ${categoryTitle} - NOOR FURNISHINGS`}
