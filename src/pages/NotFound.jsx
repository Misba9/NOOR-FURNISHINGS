...
const NotFound = () => {
  ...
  const seoData = {
    title: "Page Not Found - NOOR FURNISHINGS",
    description: "The page you're looking for doesn't exist or has been moved. Explore our premium curtains, carpets, blinds, bedcovers, and upholstery collections in Hyderabad.",
    keywords: "404 error, page not found, curtains, carpets, blinds, bedcovers, upholstery, Hyderabad, interior design",
    image: "/logo.png",
    url: "https://www.noorfurnishings.com/404",
    type: "website",
    canonical: "https://www.noorfurnishings.com/404"
  };
