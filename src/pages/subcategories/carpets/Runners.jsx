      ...
      <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                >
                  <img
                    src={productImage}
                    alt="Premium Runner Carpets - Long and Narrow Hallway Carpets"
        ...
        <section className="py-16 bg-brown-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold text-brown-900 mb-4">Runners Product Details</h2>
              <p className="text-brown-700">Everything you need to know about our runner carpets</p>
            </motion.div>
