...
const Dohar = () => {
  const productImage = '/Images/Bedcovers/Dohar.jpg';

  const features = [
    'Traditional lightweight quilted bedspreads',
  ...
  const seoData = {
    title: "Dohar Bedcovers - Traditional Lightweight Quilted Bedspreads",
    description: "Traditional lightweight quilted bedspreads perfect for year-round use. Hypoallergenic materials and breathable design for ultimate comfort in Hyderabad.",
    keywords: "dohar bedcovers, quilted bedspreads, traditional bedcovers, lightweight bedcovers, breathable bedcovers, Hyderabad bedcovers",
    image: "/Images/Bedcovers/Dohar.jpg",
    url: "https://www.noorfurnishings.com/subcategories/bedcovers/dohar",
    type: "article",
    canonical: "https://www.noorfurnishings.com/subcategories/bedcovers/dohar"
  };
    ...
    <>
      ...
      <div>
        <section className="relative h-64 md:h-80 overflow-hidden">
          ...
          <img
            src="/Images/Bedcovers/Dohar.jpg"
            alt="Premium Dohar Bedcovers - Traditional Lightweight Quilted Bedspreads"
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Dohar Bedcovers</h1>
              <p className="text-xl text-gold-200">Traditional Lightweight Quilted Bedspreads</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                >
                  <img
                    src={productImage}
                    alt="Premium Dohar Bedcovers - NOOR FURNISHINGS"
              ...
              <div>
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-3xl font-bold text-brown-900 mb-4">Premium Dohar Bedcovers</h2>
                  
                  <p className="text-brown-700 mb-6 text-lg leading-relaxed">
                    Experience the comfort of tradition with our premium dohar bedcovers, featuring lightweight 
                    quilted designs that provide the perfect balance of warmth and breathability. These 
                    traditional bedspreads offer a cozy covering solution that's ideal for year-round use, 
        ...
        <section className="py-16 bg-brown-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-brown-700">Everything you need to know about our dohar bedcovers</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Made from premium quality lightweight fabrics selected for their comfort and breathability. 
                  These materials are chosen to create a cozy yet airy covering solution that's perfect for 
                  moderate climates and year-round use.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  ...
                  Our team provides expert guidance for selecting the perfect dohar bedcover that 
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Easy to maintain with machine washable options. Our dohar bedcovers are designed for 
                  convenient care while maintaining their quality and appearance. Specific care instructions 
                  are provided with each product to ensure longevity and preserve the quilted texture.
                </p>
              </div>
            </div>
          </div>
