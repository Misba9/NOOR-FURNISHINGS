...
const FittedBedcovers = () => {
  ...
  const relatedProducts = [
    ...
    { name: 'Linen Bedcovers', image: '/Linen-Curtain.jpg', link: '/subcategories/bedcovers/linen' },
  ...
  return (
    <div>
      <section className="relative h-64 md:h-80 overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1615529162924-f8605388463a?w=1920&h=1080&fit=crop"
          alt="Fitted Bedcovers"
