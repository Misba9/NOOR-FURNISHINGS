...
const FittedBedcovers = () => {
  const productImage = '/Images/Bedcovers/Fitted-Bedcover.jpg';

  const features = [
    'Snug fit with elastic edges for a neat appearance',
  ...
  const seoData = {
    title: "Fitted Bedcovers - Snug Fit with Elastic Edges",
    description: "Premium fitted bedcovers with elastic edges for a snug fit and neat appearance. Hypoallergenic materials and temperature regulating properties in Hyderabad.",
    keywords: "fitted bedcovers, elastic bedcovers, snug fit bedcovers, premium bedcovers, hypoallergenic bedcovers, Hyderabad bedcovers",
    image: "/Images/Bedcovers/Fitted-Bedcover.jpg",
    url: "https://www.noorfurnishings.com/subcategories/bedcovers/fitted-bedcovers",
    type: "article",
    canonical: "https://www.noorfurnishings.com/subcategories/bedcovers/fitted-bedcovers"
  };
    ...
    <>
      ...
      <div>
        <section className="relative h-64 md:h-80 overflow-hidden">
          ...
          <img
            src="/Images/Bedcovers/Fitted-Bedcover.jpg"
            alt="Premium Fitted Bedcovers - Snug Fit with Elastic Edges for a Neat Appearance"
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Fitted Bedcovers</h1>
              <p className="text-xl text-gold-200">Snug Fit with Elastic Edges for a Neat Appearance</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                >
                  <img
                    src={productImage}
                    alt="Premium Fitted Bedcovers - NOOR FURNISHINGS"
              ...
              <div>
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-3xl font-bold text-brown-900 mb-4">Premium Fitted Bedcovers</h2>
                  
                  <p className="text-brown-700 mb-6 text-lg leading-relaxed">
                    Experience the perfect fit with our premium fitted bedcovers, featuring elastic edges 
                    that ensure a snug, wrinkle-free appearance on your mattress. These thoughtfully designed 
                    bedcovers combine comfort with functionality for a beautifully made bed every time.
                  </p>
        ...
        <section className="py-16 bg-brown-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-brown-700">Everything you need to know about our fitted bedcovers</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  ...
                  The elastic edges are constructed with high-quality materials that maintain their stretch 
                  and shape over time for a consistently neat appearance.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Available in standard mattress sizes with custom options for unique dimensions. 
                  Our team provides expert guidance for selecting the perfect fitted bedcover that 
                  complements your bedroom decor and ensures a perfect fit for your mattress.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Easy to maintain with machine washable options. Our fitted bedcovers are designed for 
                  convenient care while maintaining their quality and appearance. Specific care instructions 
                  are provided with each product to ensure longevity and maintain the elastic edge integrity.
                </p>
              </div>
            </div>
          </div>
...
export default FittedBedcovers;