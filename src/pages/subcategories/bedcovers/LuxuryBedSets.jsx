...
const LuxuryBedSets = () => {
  const productImage = '/Images/Bedcovers/Luxury-Bed-Set.jpg';

  const features = [
    'Premium collections with exquisite designs',
  ...
  const relatedProducts = [
    ...
    { name: 'Wedding Bed Sets', image: '/Images/Bedcovers/Wedding-Bed-Set.jpg', link: '/subcategories/bedcovers/wedding-bed-sets' },
  ];
  ...
  const seoData = {
    ...
    type: "article",
    canonical: "https://www.noorfurnishings.com/subcategories/bedcovers/luxury-bed-sets"
  };
    ...
    <>
      ...
      <div>
        <section className="relative h-64 md:h-80 overflow-hidden">
          ...
          <img
            src="/Images/Bedcovers/Luxury-Bed-Set.jpg"
            alt="Premium Luxury Bed Sets - Premium Collections with Exquisite Designs"
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Luxury Bed Sets</h1>
              <p className="text-xl text-gold-200">Premium Collections with Exquisite Designs</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                >
                  <img
                    src={productImage}
                    alt="Premium Luxury Bed Sets - NOOR FURNISHINGS"
              ...
              <div>
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-3xl font-bold text-brown-900 mb-4">Premium Luxury Bed Sets</h2>
                  
                  <p className="text-brown-700 mb-6 text-lg leading-relaxed">
                    Indulge in the ultimate comfort and sophistication with our premium luxury bed sets, 
                    featuring exquisite designs and the finest materials. These carefully curated collections 
                    combine opulent fabrics with exceptional craftsmanship to create a bedroom sanctuary 
                    that reflects your refined taste and style.
                  </p>
        ...
        <section className="py-16 bg-brown-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-brown-700">Everything you need to know about our luxury bed sets</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Made from the finest quality fabrics selected for their luxurious feel, comfort, and durability. 
                  These premium materials are chosen to create an indulgent sleeping experience while maintaining 
                  their appearance and quality over time.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  ...
                  Our team provides expert guidance for selecting the perfect luxury bed set that 
                  complements your bedroom decor and matches your sophisticated style preferences.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Easy to maintain with machine washable options. Our luxury bed sets are designed for 
