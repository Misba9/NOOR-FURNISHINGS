...
const LuxuryBedSets = () => {
  const productImage = '/Luxury-Bed-Set.jpg';
  ...
  const relatedProducts = [
    ...
    { name: 'Wedding Bed Sets', image: '/Wedding-Bed-Set.jpg', link: '/subcategories/bedcovers/wedding-bed-sets' },
  ];
