...
const RollerBlinds = () => {
  const productImage = '/Eyelet-Curtains.jpg';
  ...
  const relatedProducts = [
    { name: 'Venetian Blinds', image: '/Eyelet-Curtains.jpg', link: '/subcategories/blinds/venetian' },
    { name: 'Roman Blinds', image: '/Pleated-Elegance.jpg', link: '/subcategories/blinds/roman' },
    { name: 'Wooden Blinds', image: '/Eyelet-Curtains.jpg', link: '/subcategories/blinds/wooden' },
  ];
