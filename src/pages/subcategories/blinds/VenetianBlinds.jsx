      ...
      <div>
        <section className="relative h-64 md:h-80 overflow-hidden">
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Venetian Blinds</h1>
              <p className="text-xl text-gold-200">Classic Horizontal Slats for Light Control</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                >
                  <img
                    src={productImage}
                    alt="Premium Venetian Blinds - Classic Horizontal Slats Window Coverings"
              ...
              <div>
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-3xl font-bold text-brown-900 mb-4">Premium Venetian Blinds</h2>

                  <p className="text-brown-700 mb-6 text-lg leading-relaxed">
                    Experience timeless elegance with our premium venetian blinds, featuring classic horizontal
                    slats that offer precise light control and privacy. These versatile window coverings combine
                    functionality with sophisticated design, making them an ideal choice for any room in your home
                    or office.
                  </p>
        ...
        <section className="py-16 bg-brown-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-brown-700">Everything you need to know about our venetian blinds</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Made from premium quality materials including aluminum, wood, or faux wood slats,
                  selected for their durability, appearance, and functionality. These materials are
                  chosen to provide long-lasting performance while maintaining their aesthetic appeal.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  Available in various sizes, colors, and slat widths to perfectly match your window
                  dimensions and interior design preferences. Our team provides expert guidance for
                  selecting the perfect venetian blinds that complement your space.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-brown-700">
                  ...
                  Our experienced team ensures flawless results that showcase the classic beauty
                  and functionality of venetian blinds in your space.
                </p>
              </div>
            </div>
          </div>
