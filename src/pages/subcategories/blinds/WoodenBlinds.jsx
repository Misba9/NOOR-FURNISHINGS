...
const WoodenBlinds = () => {
  ...
  const relatedProducts = [
    { name: 'Venetian Blinds', image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=600&h=400&fit=crop', link: '/subcategories/blinds/venetian' },
    { name: 'Roman Blinds', image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=600&h=400&fit=crop', link: '/subcategories/blinds/roman' },
    { name: 'Roller Blinds', image: 'https://images.unsplash.com/photo-1616486045952-0b45b12a0a1d?w=600&h=400&fit=crop', link: '/subcategories/blinds/roller' },
  ];
  ...
  return (
    <div>
      <section className="relative h-64 md:h-80 overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1616137466211-f939a420be84?w=1920&h=1080&fit=crop"
          alt="Wooden Blinds"
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-2">Wooden Blinds</h1>
            <p className="text-xl text-gold-200">Natural Wood Slats for a Warm, Classic Look</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl font-bold text-brown-900 mb-4">Premium Wooden Blinds</h2>
                
                <p className="text-brown-700 mb-6 text-lg leading-relaxed">
                  Bring natural warmth and timeless elegance to your windows with our premium wooden blinds, 
                  featuring carefully crafted wood slats that offer both functionality and aesthetic appeal. 
                  These classic window coverings provide excellent light control and privacy while adding 
                  a touch of organic sophistication to any space.
                </p>
      ...
      <section className="py-16 bg-brown-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-brown-700">Everything you need to know about our wooden blinds</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-brown-700">
                Made from premium quality wood species selected for their durability, appearance, and 
                workability. These natural materials are carefully treated and finished to provide 
                long-lasting performance while maintaining their natural beauty and grain patterns.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-brown-700">
                Available in various sizes, wood species, and finishes to perfectly match your window 
                dimensions and interior design preferences. Our team provides expert guidance for 
                selecting the perfect wooden blinds that complement your space.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-brown-700">
                ...
                Our experienced team ensures flawless results that showcase the natural beauty 
                and functionality of wooden blinds in your space.
              </p>
            </div>
          </div>
        </div>
