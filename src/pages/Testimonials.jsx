                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <img
                      ...
                      alt={`${testimonial.name} - NOOR FURNISHINGS Customer`}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <motion.div
                ...
                className="bg-brown-50 rounded-lg overflow-hidden shadow-md"
              >
                <img src="/Eyelet-Curtains.jpg" alt="Blinds Collection - NOOR FURNISHINGS" className="w-full h-48 object-cover" loading="lazy" />
                <div className="p-4">
